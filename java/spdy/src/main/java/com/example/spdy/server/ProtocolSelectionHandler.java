...
public class ProtocolSelectionHandler implements ChannelUpstreamHandler
{
  private static final Logger LOG = Logger.getLogger(ProtocolSelectionHandler.class);
